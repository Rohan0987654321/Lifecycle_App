...
import com.example.lifecycle_app.databinding.FragmentTenthBinding

class Tenth : Fragment() {
    val msg="Fragment 10"
    lateinit var binding: FragmentTenthBinding
    ...
    override fun onCreateView(
        ...
        binding=FragmentTenthBinding.inflate(layoutInflater)
        return binding.root
    }
